        ...
        <div>
            ...
            <div className='flex items-center justify-center'>
                <div className="w-full sm:w-1/2 flex-col justify-center">
                    ...
                    <h2 className='text-4xl md:text-7xl font-bold text-orange-400 py-2'>HARISURYA M R</h2>
                    <img src={BlogProfileImage} className='w-60 block sm:hidden' alt="Blog Profile Image" />
                    <p className='py-2'>I can create stunning website for your company, Do check my works. I won't disappoint you.</p>
            ...
            <div className='flex flex-col mt-10 items-center justify-around sm:flex-row'>
                ...
                <div className='ml-4 mt-4 sm:mt-0'>
                    ...
                    <a className='button-style mt-2' href={resume} download={"resume-Downloaded"}>Download CV</a> 
